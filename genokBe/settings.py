"""
Django settings for genokBe project.
...
ACCESS_TOKEN_LIFETIME_HOURS = int(os.environ.get('ACCESS_TOKEN_LIFETIME_HOURS', 2))
...
WSGI_APPLICATION = 'genokBe.wsgi.application'
